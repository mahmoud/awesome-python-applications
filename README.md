...
## <a id="tag-internet" href="#tag-internet">Internet</a>
  ...
  1. **httpie** - ([Repo](https://github.com/jakubroztocil/httpie), [Home](https://httpie.org/), [PyPI](https://pypi.org/project/httpie/)) Command-line HTTP client with intuitive UI, JSON support, syntax highlighting, wget-like downloads, extensions, etc. `(dev, linux, windows, mac, console)`
...
### <a id="tag-dev-other" href="#tag-dev-other">Other Dev projects</a>
  ...
  1. **httpie** - ([Repo](https://github.com/jakubroztocil/httpie), [Home](https://httpie.org/), [PyPI](https://pypi.org/project/httpie/)) Command-line HTTP client with intuitive UI, JSON support, syntax highlighting, wget-like downloads, extensions, etc. `(internet, linux, windows, mac, console)`
